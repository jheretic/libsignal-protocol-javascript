      ...
      return this.storage.isTrustedIdentity(
        ...
        return this.storage.loadSession(address).then(function(serialized) {
          ...
          if (serialized !== undefined) {
            record = record.SessionRecord.deserialize(serialized);
          } else {
            record = new record.SessionRecord(device.identityKey, device.registrationId);
          }
    ...
    return this.storage.getIdentityKeyPair().then(function(ourIdentityKey) {
        ...
        return Promise.all([
            ...
            if (isInitiator) {
                ...
                session.indexInfo.baseKeyType = record.BaseKeyType.OURS;
                ...
                session.indexInfo.baseKeyType = record.BaseKeyType.THEIRS;
  ...
  calculateSendingRatchet: function(session, remoteKey) {
      ...
      return crypto.crypto.ECDHE(
          ...
          session[util.toString(ratchet.ephemeralKeyPair.pubKey)] = {
              ...
              chainType   : record.ChainType.SENDING
          };
...
exports.SessionBuilder = function (storage, remoteAddress) {
